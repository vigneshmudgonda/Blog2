...
const quillModules = {
 ...
 const quillModules = {
  ...
  dragAndDrop: {
    draggables: [
      {
        content_type_pattern: /^image\/.*/, // accept only images
        tag: "img",
        attr: "src",
      },
      {
        content_type_pattern: /^video\/.*/, // accept only videos
        tag: "video",
        attr: "src",
      },
      {
        content_type_pattern: /^text\/html$/, // iframes
        tag: "iframe",
        attr: "src",
      },
    ],
