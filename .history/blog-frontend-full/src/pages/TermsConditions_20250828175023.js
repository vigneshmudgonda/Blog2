...
export default function TermsAndConditions() {
  return (
    <div className="container py-5" style={{ maxWidth: "900px" }}>
      <Helmet>
        <title>Terms & Conditions | Unique Tech</title>
        <meta
          name="description"
          content="Read the Terms & Conditions of using Unique Tech's website and YouTube content, including user responsibilities, content usage, and limitations of liability."
        />
      </Helmet>
