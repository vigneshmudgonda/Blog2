        ...
        <div className="container">
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-5">
              <div className="bg-light rounded-circle ratio ratio-1x1 d-flex align-items-center justify-content-center shadow-soft">
                <img alt="Profile" className="rounded-circle w-75 h-75 object-fit-cover" src="blog-frontend-full/public/picofme.png" />
              </div>
            </div>
          </div>
        </div>
