    ...
    <div className="container my-5">
      ...
      <div className="card shadow p-4 mb-5 border-0">
        ...
        <form onSubmit={handleSubmit}>
         ...
         import dynamic from "next/dynamic"; // optional, if using Next.js
...
<div className="mb-3">
  ...
  {editorLoaded && ReactQuill ? (
    <ReactQuill
      key={editingId || "new"} // ensures editor remounts correctly
      theme="snow"
      value={form.content || ""} // always provide a string
