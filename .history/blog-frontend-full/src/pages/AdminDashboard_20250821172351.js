...
<div className="mb-3">
  ...
  {form.content !== null && ( // render editor only when content is ready
    <ReactQuill
      theme="snow"
      value={form.content} // always a string
      onChange={handleContentChange}
      placeholder="Write your blog content here..."
      style={{ height: "400px", marginBottom: "80px" }}
      className={`content-editor ${form.fullscreen ? "fullscreen-editor" : ""}`}
      modules={{
        toolbar: {
          container: [
            [{ header: [1, 2, 3, false] }],
