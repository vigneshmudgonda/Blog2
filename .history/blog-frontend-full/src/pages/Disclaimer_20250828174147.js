...
export default function Disclaimer() {
  return (
    <div className="container py-5" style={{ maxWidth: "900px" }}>
      {/* ✅ Helmet SEO */}
      <Helmet>
        <title>Disclaimer | Unique Tech</title>
        <meta 
          name="description" 
          content="Read the disclaimer of Unique Tech. Learn about the limitations, accuracy, and affiliate disclosures related to our tutorials, guides, and content." 
        />
      </Helmet>
