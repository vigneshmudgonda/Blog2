...
export default function Contact(){
  ...
  return (
    <div className="container py-4">
      {/* ✅ Helmet for SEO */}
      <Helmet>
        <title>Contact Us | Unique Tech</title>
        <meta 
          name="description" 
          content="Get in touch with Unique Tech. Send us your queries, feedback, or collaboration requests through our contact form." 
        />
      </Helmet>
