...
export default function Navbar(){
  return (
    <nav className="navbar navbar-expand-lg bg-dark text-light border-bottom sticky-top">bg-dark text-light pt-5 pb-3 mt-5
      <div className="container">
        <Link className="navbar-brand fw-bold" to="/">MY BLOG</Link>
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#nav">
          <span className="navbar-toggler-icon"></span>
        </button>
        <div id="nav" className="collapse navbar-collapse text-light pt-2">
