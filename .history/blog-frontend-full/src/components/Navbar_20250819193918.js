      ...
      <div className="container">
        ...
        <div id="nav" className="collapse navbar-collapse ">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item text-light "><NavLink className="nav-link" to="/contact">Contact</NavLink></li>
            <li className="nav-item text-light "><NavLink className="nav-link" to="/reviews">Reviews</NavLink></li>
            <li className="nav-item text-light "><NavLink className="nav-link" to="/login">Admin</NavLink></li>
          </ul>
        </div>
      </div>
    </nav>
